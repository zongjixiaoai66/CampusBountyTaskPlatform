...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 任务资讯公告名称
     */
    @ColumnInfo(comment="任务资讯公告名称",type="varchar(200)")
     ...
     * 任务资讯公告图片
     */
    @ColumnInfo(comment="任务资讯公告图片",type="varchar(200)")
	...
	@DateTimeFormat
    @ColumnInfo(comment="任务资讯公告发布时间",type="timestamp")
     ...
     * 任务资讯公告详情
     */
    @ColumnInfo(comment="任务资讯公告详情",type="longtext")
