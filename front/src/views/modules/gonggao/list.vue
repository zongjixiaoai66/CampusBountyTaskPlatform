        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '任务资讯公告名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.gonggaoName" placeholder="任务资讯公告名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanxuanshang/upload/gonggaoMuBan.xls"
                        >批量导入任务资讯公告数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gonggao','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                //本表字段
                     '任务资讯公告名称': "gonggaoName",
                     '任务资讯公告图片': "gonggaoPhoto",
                     '公告类型': "gonggaoValue",
                     '任务资讯公告发布时间': "insertTime",
            },
