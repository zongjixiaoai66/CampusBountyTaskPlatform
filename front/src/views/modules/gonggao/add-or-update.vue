    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="任务资讯公告名称" prop="gonggaoName">
                       <el-input v-model="ruleForm.gonggaoName"
                                 placeholder="任务资讯公告名称" clearable  :readonly="ro.gonggaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="任务资讯公告名称" prop="gonggaoName">
                           <el-input v-model="ruleForm.gonggaoName"
                                     placeholder="任务资讯公告名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gonggaoPhoto" label="任务资讯公告图片" prop="gonggaoPhoto">
                        <file-upload
                            tip="点击上传任务资讯公告图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.gonggaoPhoto" label="任务资讯公告图片" prop="gonggaoPhoto">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="任务资讯公告详情" prop="gonggaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gonggaoContent" label="任务资讯公告详情" prop="gonggaoContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   gonggaoName: [
                              { required: true, message: '任务资讯公告名称不能为空', trigger: 'blur' },
                          ],
                   gonggaoPhoto: [
                              { required: true, message: '任务资讯公告图片不能为空', trigger: 'blur' },
                          ],
                   gonggaoTypes: [
                   ...
                   insertTime: [
                              { required: true, message: '任务资讯公告发布时间不能为空', trigger: 'blur' },
                          ],
                   gonggaoContent: [
                              { required: true, message: '任务资讯公告详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
